...
public class Praktikum1 {
    public static void main(String[] args) {        
        ...
        // Menginisiasikan variable: mendeklarasikan variable dan menetapkan nilai secara bersamaan
        int myNumber = 2;
        ...
        // Penulisan nama variable yang benar harus mendeskripsikan isi dari variable tersebbut, dan menggunakan camelCase
        ...
        System.out.println(5.0/2); // hasilnya akan menjadi desimal 2.5 (sama dengan 5.0 / 2.0 -> dirubah menjadi desimal secara implisit)
        
        // Menghitung angka dengan tipe integer
        int numberX = 13;
        int numberY = 4;
        System.out.println(numberX / number); // seharusnya hasilnya 3.25, namun akan di bulatkan mejadi 3. karena tipe datanya integer, bukan double
        
        // Cast
        int numberA = 13;
        int numberB = 4;
        System.out.println((double)numberA / numberB); // karena salah satu dirubah menjadi double, jadi hasilnya akan menjadi double. hasilnya 3.25
    }
}

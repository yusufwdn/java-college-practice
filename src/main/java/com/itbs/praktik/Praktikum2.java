...
public class Praktikum2 {
    public static void main(String[] args) {
        ...
        // Operator logika - Dan (&&)
        // Operator "dan (&&)" akan bernilai true apabila seluruh perbandingannya bernilai true
        int x;
        ...
        // Operator "or (||)" akan bernilai true apabila salah satu dari perbandingannya bernilai true
        x = 5; // ketika x bernilai 5
        System.out.println(x < 10 || x > 30); // hasilnya true
        ...
        // Operator "bukan/not (!)" akan bernilai true apabila nilai perbandingannya adalah kebalikannya
        x = 20;
        ...
        switch(rank) {
            ...
            break;
            default: // jika tidak ada yang memenuhi kondisi pada case diatas, maka nilai pada default akan menjadi nilai balikannya 
        ...
        //     // i++; // karena variabel tidak diperbarui, maka nilai i tidak akan memenuhi kondisi while. terjadilah infinite loop
        // }
        ...
        for (int j = 1; j <= 10; j++) {
            if (i > 5) { // jika variabel j bernilai lebih dari 5, maka jalankan 'break', yang berarti loop akan dianggap selesai dan tidak akan dilanjutkan
                break;
            }
        ...
        for (int j = 1; j <= 10; j++) {
            if (i % 3 == 0) { // jika nilai pada i dapat habis dibagi 3, maka akan di skip ke proses loop selanjutnya
                break;
            }
